...
class DebugRuntime:
    ...
    def should_pause(self, line: int) -> bool:
        ...
        if self.step_mode == "over":
            ...
            if self.call_depth <= self.step_depth or (
                self.step_depth == 0 and self.call_depth == 1
            ):
    ...
    while True:
        ...
        if sys.stdin in select.select([sys.stdin], [], [], 0.1)[0]:
            ...
            if line:
                ...
                if (
                    line in ["stopOnEntry", "breakpoint:", "clearBreakpoints:"]
                    or line.startswith("breakpoint:")
                    or line.startswith("clearBreakpoints:")
                ):
